...
cp "$DS"/js/nav.js "$DS"/js/reveal.js "$DS"/js/marquee.js "$DS"/js/toast.js "$DS"/js/segmented.js "$DS"/js/tilt.js \
   "$DS"/js/smooth-scroll.js "$DS"/js/scroll-progress.js "$DS"/js/split-text.js "$DS"/js/count-up.js "$DS"/js/magnetic.js "$DS"/js/night-sky.js "$DS"/js/theme-toggle.js "$DS"/js/paint-scene.js "$DS"/js/hscroll.js "$DS"/js/text-roll.js js/ds/
