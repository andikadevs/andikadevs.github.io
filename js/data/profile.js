...
export const experience = [
  {
    ...
    body: {
      ...
      id: "Saya membangun sistem yang digunakan Toploker setiap hari: OTO Management, SnapCRM, jobs scraper, TopMatch, dan katalog CV. Fokus utama saya adalah menemukan proses manual yang menghambat tim, lalu mengotomatiskannya.",
    },
  ...
  },
  {
    ...
    body: {
      ...
      id: "Developer di tim internasional. Saya membangun website internasional beserta platform kampus di sekitarnya: Passport untuk SSO, Depot untuk media, serta Conflow, Bio, dan Corpus.",
    },
  ...
  },
  {
    ...
    body: {
      ...
      id: "Studio web dan aplikasi di Semarang dengan enam layanan: website studio, undangan pernikahan digital, halaman ucapan ulang tahun, editor undangan dengan checkout, portal afiliasi, dan panel admin yang mengelola semuanya.",
    },
  ...
  },
  {
    ...
    body: {
      ...
      id: "Tempat saya belajar merilis perangkat lunak untuk pengguna nyata: website perusahaan, server SSO OAuth2, pelacakan kendaraan, e-parking, panel ekspor data, dan API MRS Genius.",
    },
...
export const highlights = [
  { tone: "sky",   value: "2×",    label: { en: "Competition", id: "Kompetisi" },
    title: { en: "LKS regency winner", id: "Juara LKS tingkat kabupaten" },
  ...
  { tone: "brand", value: "800",   label: { en: "English", id: "Bahasa Inggris" },
    ...
    body: { en: "Advanced level. I work day to day with the international office.", id: "Level advanced, terbiasa bekerja dengan kantor internasional." } },
  { tone: "white", value: "100%",  label: { en: "University", id: "Pendidikan" },
    title: { en: "Full scholarship", id: "Beasiswa penuh" },
    body: { en: "Computer Engineering at Universitas STEKOM, while working full-time.", id: "Teknik Komputer di Universitas STEKOM, sambil bekerja penuh waktu." } },
  { tone: "sky",   value: "11+",   label: { en: "Identity", id: "Identitas" },
    title: { en: "Apps on one login", id: "Aplikasi, satu login" },
    body: { en: "Campus apps signing in through the SSO I built, STEKOM Passport.", id: "Aplikasi kampus yang terhubung ke SSO buatan saya, STEKOM Passport." } },
  { tone: "brand", value: "100K+", label: { en: "Automation", id: "Otomasi" },
    title: { en: "Leads handled", id: "Prospek dikelola" },
    body: { en: "Managed and messaged over WhatsApp by SnapCRM.", id: "Dikelola dan dihubungi melalui WhatsApp oleh SnapCRM." } },
